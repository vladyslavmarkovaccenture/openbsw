...
* **2. Flash the Software**:
  ...
  - a. Launch S32 Design Studio (We tested on S32 Design Studio for ARM Version 2.2).
...
* **3. Configure Tera Term for Serial Debug**
  ...
  - a. Start Tera Term.
  - b. Select the radio button labeled “Serial.”
  - c. Choose the COM port from the drop-down menu for the device you want to connect to and
       click “OK.”
  ...
  - d. Click on “Setup” in the menu bar and select “Serial Port.”
  - e. In the Serial Port Setup menu, configure the protocols as follows:
  - f. Tera Term should now be properly configured for serial communication with EVB.
...
* **5. Testing Sequence: PWM**
    ...
    Duty Cycle of PWM can be changed using 2 ways:
     a. Through potentiometer
     b. Through console command
...
* **6. Testing Sequence: IO**
    ...
    IO can be verified using 2 ways:
     a. Through pressing the switch button sw3 on EVB
     b. Through console command
