...
void setCharIOApi(const tCharIOApi* const api)
{
    charIOApi = *api;
}
...
void charIoSetAsynchron()
{
    charIOApi.setAsynchron();
}

void charIoSetSynchron()
{
    charIOApi.setSynchron();
}

void charIoBackground()
{
    charIOApi.Idle();
}
...
int charIoGetc()
{
    return (charIOApi.getc());
}

int charIoPutc(const int c)
{
    return (charIOApi.putc(c));
}

int charIO__inchar()
{
    return (charIOApi.__inchar());
}

int charIO__outchar(const int c, const int last)
{
    return (charIOApi.__outchar(c,last));
}
