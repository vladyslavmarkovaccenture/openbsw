...
Io::PinConfiguration const Io::fPinConfiguration[Io::NUMBER_OF_IOS] = {
    ...
    /* 60  */ {_PORTD_, PD5, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 61  */ {_PORTD_, PD6, _IN, 0, ALT2},
    /* 62  */ {_PORTD_, PD7, _OUT, 0, ALT2 | STRENGTH_ON},
    /* 63  */ {_PORTD_, PD8, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 64  */ {_PORTD_, PD9, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 65  */ {_PORTD_, PD10, _OUT, FILTER_ACTIVE | FILTER_TICK1, GPIO | STRENGTH_ON | PULLUP},
    /* 66  */ {_PORTD_, PD11, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 67  */ {_PORTD_, PD12, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 68  */ {_PORTD_, PD13, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 69  */ {_PORTD_, PD14, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 70  */ {_PORTD_, PD15, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 71  */ {_PORTD_, PD16, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 72  */ {_PORTD_, PD17, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    ...
    /* 91  */ {_PORTE_, PE21, _OUT, FILTER_ACTIVE | FILTER_TICK1, GPIO | STRENGTH_ON},
