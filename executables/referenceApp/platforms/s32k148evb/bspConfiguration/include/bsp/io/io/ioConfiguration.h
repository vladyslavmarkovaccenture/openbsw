...
Io::PinConfiguration const Io::fPinConfiguration[Io::NUMBER_OF_IOS] = {
    ...
    /* 48  */ {_PORTC_, PC12, _IN, FILTER_ACTIVE | FILTER_TICK1, GPIO},
    ...
    /* 55  */ {_PORTC_, PC29, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},

    /* 56  */ {_PORTD_, PD0, _OUT, 0, ALT3 | STRENGTH_ON | PULLUP},
    /* 57  */ {_PORTD_, PD1, _IN, 0, ALT3 | PULLUP},
    /* 58  */ {_PORTD_, PD2, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 59  */ {_PORTD_, PD3, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 60  */ {_PORTD_, PD4, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    ...
    /* 75  */ {_PORTE_, PE0, _OUT, 0, ALT5 | STRENGTH_ON},
    /* 76  */ {_PORTE_, PE1, _OUT, 0, GPIO | STRENGTH_ON | PULLUP},
    /* 77  */ {_PORTE_, PE2, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 78  */ {_PORTE_, PE3, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 79  */ {_PORTE_, PE4, _IN, 0, ALT5},
    /* 80  */ {_PORTE_, PE5, _OUT, 0, ALT5 | STRENGTH_ON},
    /* 81  */ {_PORTE_, PE6, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 82  */ {_PORTE_, PE7, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 83  */ {_PORTE_, PE8, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 84  */ {_PORTE_, PE9, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 85  */ {_PORTE_, PE10, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 86  */ {_PORTE_, PE11, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 87  */ {_PORTE_, PE12, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 88  */ {_PORTE_, PE13, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 89  */ {_PORTE_, PE14, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 90  */ {_PORTE_, PE15, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 91  */ {_PORTE_, PE16, _IN, FILTER_ACTIVE | FILTER_TICK1, PINDISABLE},
    /* 92  */ {_PORTE_, PE21, _OUT, FILTER_ACTIVE | FILTER_TICK1, GPIO | STRENGTH_ON},
    /* 93  */ {_PORTE_, PE22, _OUT, FILTER_ACTIVE | FILTER_TICK1, ALT2 | STRENGTH_ON},
    /* 94  */ {_PORTE_, PE23, _OUT, FILTER_ACTIVE | FILTER_TICK1, ALT2 | STRENGTH_ON},
};
